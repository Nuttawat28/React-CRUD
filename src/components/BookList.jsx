...
export default function BookList() {
  ...
  useEffect(() => {
    axios
      .get("https://node58297-noderestnuttawat.proen.app.ruk-com.cloud/books")
      .then((response) => {
  ...
  const viewBook = (id) => {
    axios
    .get(`https://node58297-noderestnuttawat.proen.app.ruk-com.cloud/books/${id}`)
      .then((response) => {
  ...
  const deleteBook = (id) => {
    axios
      .delete(`https://node58297-noderestnuttawat.proen.app.ruk-com.cloud/books/${id}`)
      .then(() => {
